...
def main():
    ...
    # Single output regression - Predicting petal width based on sepal length and width
    ...
    # Single output regression with L2 regularization- Predicting petal width based on sepal length and width
    X_single = iris.data[:, :2]           
    y_single = iris.data[:, 3]            
    train_regression(X_single, y_single,
